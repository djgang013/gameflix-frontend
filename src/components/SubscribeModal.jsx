...
export default function SubscribeModal({ isOpen, onClose, onSubscribe, gameTitle }) {
        ...
        <div style={styles.overlay}>
            <div style={styles.modal}>
                ...
                <div style={styles.buttonRow}>
                    <button style={styles.cancelButton} onClick={onClose} disabled={loading}>Not now</button>
                    <button style={{ ...styles.subscribeButton, opacity: loading ? 0.7 : 1 }} onClick={handleSubscribe} disabled={loading}>
